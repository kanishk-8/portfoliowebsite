        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-2">
            {navItems.map((item, index) => (
              <button
                ...
                className={`relative px-5 py-2.5 text-gray-300 hover:text-white rounded-xl text-sm font-medium transition-all duration-300 group overflow-hidden hover:scale-105 active:scale-95 hover:-translate-y-1 ${
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a
              ...
              className="bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white px-5 py-2 rounded-full text-sm font-medium transition-all duration-200 border border-gray-700 hover:border-gray-600 flex items-center space-x-2 hover:scale-105 hover:-translate-y-1 active:scale-95"
            >
              <span>📄</span>
              <span>Resume</span>
            </a>
            <button
              ...
              className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 hover:-translate-y-1 active:scale-95"
            >
              Hire Me
            </button>
          </div>
          ...
          <div className="md:hidden">
            <button
              ...
              className="relative w-10 h-10 rounded-lg bg-gray-800 border border-gray-700 hover:border-gray-600 flex items-center justify-center text-gray-400 hover:text-white focus:outline-none transition-all duration-200 active:scale-95"
            >
          ...
          <div className="px-2 pt-2 pb-6 space-y-2 bg-gray-800/95 backdrop-blur-xl rounded-xl mt-4 border border-gray-700">
            {navItems.map((item, index) => (
              <button
                key={item.name}
                onClick={() => scrollToSection(item.href)}
                className={`block w-full text-left px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-700/50 rounded-lg text-base font-medium transition-all duration-200 ${
            ...
            {/* Mobile CTA */}
            <div
              className={`pt-4 border-t border-gray-700 space-y-2 ${
            ...
            >
              <a
                href="/resume.pdf"
                download="Kanishk_Kumar_Resume.pdf"
                className="w-full bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-white px-4 py-3 rounded-lg text-base font-medium transition-all duration-200 flex items-center justify-center space-x-2 active:scale-95"
              >
                <span>📄</span>
              ...
              <button
                onClick={() => scrollToSection("#contact")}
                className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-4 py-3 rounded-lg text-base font-medium transition-all duration-200 active:scale-95"
              >
                Hire Me
              </button>
            </div>
